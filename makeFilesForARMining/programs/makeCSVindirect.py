...
import numpy
#FALE KLJUCNE RECI
row_lists=[["repeat", "taxonomy", "disorder_content", "intersect_ind", "contains_ind", "keywords"]]
f=open("indirect31.fasta.load", "r")
#f=open("proba.txt", "r")
...
with open('datasetIndirectNew.csv', 'w', newline='') as file:
