...
data<-read.csv("R/transactionsWithKeywords.csv")
head(data)
...
plot(res)
plot(res, method = "graph", limit = 5)
f<-file("rulesWithKeywords2.txt")
sink(file=f)
