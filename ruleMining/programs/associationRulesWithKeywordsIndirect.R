...
data<-read.csv("R/transactionsIndirectWithKeywords.csv")
head(data)
...
f<-file("rulesWithKeywordsIndirect1.txt")
sink(file=f)
...
f<-file("rulesWithKeywordsIndirect2.txt")
sink(file=f)
...
plot(res)
plot(res, method = "graph", limit = 10)
f<-file("rulesWithKeywordsIndirect3.txt")
sink(file=f)
...
plot(res)
plot(res, method = "graph", limit = 10)
f<-file("rulesWithKeywordsIndirect4.txt")
sink(file=f)
